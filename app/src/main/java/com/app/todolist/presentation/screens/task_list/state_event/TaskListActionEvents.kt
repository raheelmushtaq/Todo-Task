...
/*TaskListActionEvents is used to as between TasklistScreen and TaslListViewModel
...
sealed class TaskListActionEvents {
    ...
    // when user is entering the text for searching the task in the serch field, then this event is sent to viewmodel
    ...
    // this takes a Tasks as paramter which isused to delete the task from datastore
    ...
    // this takes a Tasks as paramter which isused to markComplete the task from datastore
